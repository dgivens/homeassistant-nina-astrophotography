...
| [`2026-09-19-lovelace-entity-resolution.md`](2026-09-19-lovelace-entity-resolution.md) | Post-2.0 · Lovelace entity resolution | M | Frontend registry fields confirmed; `test_cards.py` pins every `_eid` call; `nina-observatory-card` resolves with no config and survives a child-device rename |
