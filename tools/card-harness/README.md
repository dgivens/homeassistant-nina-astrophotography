...
(a whole night's session, dumped from inside it). Only the last holds any
frames: the session is measured against the clock, and the other two are dumped
months after theirs. Device ids are
